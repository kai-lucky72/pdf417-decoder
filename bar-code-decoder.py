...
if __name__ == "__main__":
    ...
    # Decode all barcodes
    results = decode_all_barcodes(image_file)from PIL import Image
from pylibdmtx.pylibdmtx import decode

# Load the image
image = Image.open("40ea3e26-4931-448b-9a70-a61cbfb2e62c.png")

# Decode the Data Matrix
decoded = decode(image)
if decoded:
    print("Decoded text:", decoded[0].data.decode("utf-8"))
else:
    print("No code found.")
